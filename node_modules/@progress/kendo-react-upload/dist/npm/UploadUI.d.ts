...
export declare class UploadUI extends React.Component<UploadUIProps, {}> {
    ...
    private readonly groupsCount;
    private readonly lastGroupIndex;
    private readonly addButtonIndex;
    private readonly clearButtonIndex;
    private readonly uploadButtonIndex;
