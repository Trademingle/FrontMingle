...
var UploadListActionButton = /** @class */ (function (_super) {
    ...
    function UploadListActionButton(props) {
        ...
        _this.buttonClassNames = function (type) {
            ...
            return kendo_react_common_1.classNames('k-button k-button-icon k-flat k-upload-action', _this.props.disabled ? 'k-state-disabled' : '', (actionFocused && type === 'action') || (retryFocused && type === 'retry') ? 'k-state-focused' : '');
        };
    ...
    UploadListActionButton.prototype.render = function () {
        ...
        var actionButtonClassNames = kendo_react_common_1.classNames('k-icon', status === UploadFileStatus_1.UploadFileStatus.Uploading ? 'k-cancel k-i-deny' : '', status !== UploadFileStatus_1.UploadFileStatus.Uploading ? 'k-delete k-i-x' : '');
...
kendo_react_intl_1.registerForLocalization(UploadListActionButton);
