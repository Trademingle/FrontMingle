...
var UploadListMultiItem = /** @class */ (function (_super) {
            ...
            return files.map(function (file) {
                return (React.createElement("span", { key: file.name, className: 'k-file-name-size-wrapper' },
                    ...
                    utils_1.default.fileHasValidationErrors(file) ?
                        ...
                        (React.createElement("span", { key: file.name + "-size", className: 'k-file-size' }, utils_1.default.getTotalFilesSizeMessage([file])))));
            });
        };
        /**
         * @hidden
    ...
    UploadListMultiItem.prototype.render = function () {
        ...
        var itemClassName = kendo_react_common_1.classNames('k-file-multiple');
        ...
        return (React.createElement("div", { className: itemClassName },
            ...
            React.createElement("span", { className: "k-multiple-files-wrapper" },
                ...
                !isUploadFailed ?
                    (progress !== 100 ?
                        (React.createElement("span", { className: 'k-file-information' }, totalMessage + ": " + files.length + " " + filesMessage + ", " + utils_1.default.getTotalFilesSizeMessage(files))) :
...
kendo_react_intl_1.registerForLocalization(UploadListMultiItem);
