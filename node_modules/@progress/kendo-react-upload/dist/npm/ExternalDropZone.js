...
exports.ExternalDropZone = React.forwardRef(function (props, ref) {
    ...
    var localizedNote = localization.toLanguageString(messages_1.dropZoneNote, messages_1.messages[messages_1.dropZoneNote]);
    ...
    return (React.createElement("div", { ref: externalDropZoneRef, id: props.id, className: kendo_react_common_1.classNames('k-external-dropzone', {
            'k-external-dropzone-hover': overDropZone,
            'k-state-disabled': props.disabled
        }, props.className), tabIndex: kendo_react_common_1.getTabIndex(props.tabIndex, props.disabled, undefined), onDrop: handleOnDrop, onDragEnter: handleOnElementDragEnter, onDragOver: handleOnElementDragOver },
