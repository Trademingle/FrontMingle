...
export declare class Upload extends React.Component<UploadProps, UploadState> {
     ...
     * @hidden
     */
    onUploadSuccess: (uid: string, event?: AxiosResponse<never>) => void;
    /**
     * @hidden
     */
    onUploadError: (uid: string, event?: AxiosResponse<never>) => void;
    /**
     * @hidden
     */
     ...
     * @hidden
     */
    onRemoveSuccess: (uid: string, event?: AxiosResponse<never>) => void;
    /**
     * @hidden
     */
    onRemoveError: (uid: string, event?: AxiosResponse<never>) => void;
    /**
     * @hidden
     */
