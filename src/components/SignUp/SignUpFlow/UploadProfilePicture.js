...
import styles from './signUpCss/verifyEmail.module.css';
    ...
    return (
      <div>
        ...
        <div>
            ...
            <ContinueButton type="submit" className={styles.continueWithEmailButton} onClick={this.props.onEmailClick}>
              <p className={styles.continueWithEmail}>Continue </p>
            </ContinueButton>
        </div>
